<div class="footer-area-wrapper bg-white">
        ...
        <div class="container-fluid container-fluid--cp-100">
            <div class="row footer-widget-wrapper">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 footer-widget">
                    ...
                    <ul class="footer-widet__footer-menu section-space--mt_60 d-non d-lg-block">
    ...
    <div class="footer-copyright-area border-top section-space--ptb-30">
        <div class="container-fluid container-fluid--cp-100">
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-6 order-md-1 order-2">
                    <span class="copyright-text text-center text-md-start">&copy; 2025 ErnesWihandaP.
                ...
                <div class="col-lg-6 col-md-6 order-md-2 order-1">
                    <div class="footer-bottom-social">
                        ...
                        <ul class="list footer-social-networks">
                            <li class="item">
                                <a href="https://twtiter.com" target="_blank" aria-label="Twitter">
