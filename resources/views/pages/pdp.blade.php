        ...
        <div class="container">
            ...
            <div class="col-lg-5 col-md-6 col-sm-12 col-xs-12">
                <div class="product-details-content">
                    ...
                    <h3 class="price" id="product-price">x</h3>
                    <div class="stock mt--10" id="product-status-stock">x</div>
                    <div class="quickview-paragraph mt--10"><p id="product-description">x</p></div>
